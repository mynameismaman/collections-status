  ...
  return (
    <div className="flex flex-col w-60 h-fit rounded overflow-hidden shadow-lg">
      ...
      <div className="p-1 text-sm flex flex-row justify-between">
        <button className="bg-yellow-500 hover:bg-yellow-400 text-gray-800 text-xs font-bold py-1 px-2 rounded inline-flex items-center" onClick={download}>
          <svg
        ...
        <button className="bg-slate-500 hover:bg-slate-400 text-white text-xs font-bold py-1 px-2 rounded inline-flex items-center" onClick={show}>
